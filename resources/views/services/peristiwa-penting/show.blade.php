{{-- resources/views/services/peristiwa-penting/show.blade.php --}}
@extends('layouts.app')
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="mb-8">
            <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-6">
                ...
                <span>/</span>
                <a href="{{ route('services.peristiwa-penting.index') }}" class="hover:text-blue-600">Peristiwa Penting</a>
                <span>/</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                <h1 class="text-3xl font-bold text-gray-800 mb-6">{{ $service->name }}</h1>
