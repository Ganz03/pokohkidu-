{{-- resources/views/services/kia/index.blade.php --}}
@extends('layouts.app')

@section('title', 'Layanan Kartu Identitas Anak (KIA)')

@section('content')
<div class="bg-gray-50 min-h-screen">
    <div class="container mx-auto px-6 py-12">
        <div class="mb-10">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Layanan Kartu Identitas Anak (KIA)</h1>
            <p class="text-gray-600">Pilih jenis layanan KIA yang Anda butuhkan</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($services as $service)
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <a href="{{ route('services.kia.show', $service->slug) }}" 
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-gray-600">Layanan KIA belum tersedia saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
