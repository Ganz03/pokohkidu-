...
use App\Filament\Resources\KkServiceResource\Pages;
...
class KkServiceResource extends Resource
{
    protected static ?string $model = KkService::class;

    protected static ?string $navigationIcon = 'heroicon-o-identification';

    protected static ?string $navigationLabel = 'Layanan KK';

    protected static ?string $modelLabel = 'Layanan KK';

    protected static ?string $pluralModelLabel = 'Layanan KK';
                ...
                Forms\Components\Section::make('Informasi Layanan')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('slug')
                            ->label('Slug')
                            ->required()
                            ->unique(KkService::class, 'slug', ignoreRecord: true)
    ...
    {
        return [
            'index' => Pages\ListKkServices::route('/'),
            'create' => Pages\CreateKkService::route('/create'),
            'edit' => Pages\EditKkService::route('/{record}/edit'),
        ];
    }
}