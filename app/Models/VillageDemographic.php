...
class VillageDemographic extends Model
{
    ...
    /**
     * Get the active village demographic
     */
    ...
    /**
     * Set this village demographic as active and deactivate others
     */
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($model) {
            if ($model->is_active && static::where('is_active', true)->count() === 1) {
                throw new \Exception('Cannot delete the only active village demographic. Please activate another one first.');
            }
        });
    }
}